        ...
        MissionProgressLayer.getNotContainedInLocalDatas(function ()
            ...
            local function afterCaptured(succeed, outputFile)
                if succeed then
                    ...
                    sp:setScaleX((s_RIGHT_X - s_LEFT_X) / sp:getContentSize().width)
                    sp:setScaleY(s_DESIGN_HEIGHT / sp:getContentSize().height)
                    print('afterCaptured',sp:getContentSize().width,sp:getContentSize().height)

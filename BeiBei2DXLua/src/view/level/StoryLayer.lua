...
function StoryLayer:addIntroduction1()
	...
	self:addChild(drama)
	self:callFuncWithDelay(4.5, function()
		self:directStory(1)
	end)
end
...
function StoryLayer:addIntroduction2() 
	...
	self:addChild(drama)
	self:callFuncWithDelay(3, function()
		self:directStory(2)
	end)
end
...
function StoryLayer:addIntroduction3()
	...
	self:addChild(drama)
	self:callFuncWithDelay(3.5, function()
		self:directStory(3)
	end)
end
...
function StoryLayer:addIntroduction7()
	...
	-- TODO
	-- self:callFuncWithDelay(3, function()
	-- 	local action = cc.FadeOut:create(1.0)
	-- 	drama.runAction(action)
	-- end)
